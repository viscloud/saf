...
void Run(bool display, const std::string& sender_endpoint,
         const std::string& sender_package_type, const std::string& aux = "") {
  std::cout << "Run visualizer demo" << std::endl;
...
int main(int argc, char* argv[]) {
  ...
  Run(display, sender_endpoint, sender_package_type, camera_name);
