...
#ifndef SAF_OPERATOR_STRIDER_H_
#define SAF_OPERATOR_STRIDER_H_
...
// The Strider operator passes one out of every "stride" frames and drops all
// other frames.
class Strider : public Operator {
 public:
