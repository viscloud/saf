...
#ifndef SAF_OPERATOR_FLOW_CONTROL_FLOW_CONTROL_EXIT_H_
#define SAF_OPERATOR_FLOW_CONTROL_FLOW_CONTROL_EXIT_H_
...
class FlowControlExit : public Operator {
 public:
  FlowControlExit();
...
#endif  // SAF_OPERATOR_FLOW_CONTROL_FLOW_CONTROL_EXIT_H_
