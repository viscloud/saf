...
#ifndef SAF_UTILS_FP16_H_
#define SAF_UTILS_FP16_H_
...
static inline unsigned short float2half(unsigned f) {
...
static inline void fp16tofloat(float* dst, unsigned char* src, unsigned nelem) {
  unsigned i;
